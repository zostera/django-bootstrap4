...
The default CDN URL is pinned to Bootstrap 4.6.2 — confirmed to be the final 4.x release
(Bootstrap itself has moved on to 5.x, no further 4.x releases are expected). Nothing to
