...
class DateTimeTestCase(BootstrapTestCase):
    ...
    def test_input_type_admin_split_date_time(self):
        ...
        expected_html = (
            ...
            '<p class="datetime">'
            "Date: "
            '<input type="text" name="test_0" class="form-control vDateField" size="10" placeholder="Test" required id="id_test_0">'
            "<br>"
            "Time: "
            '<input type="text" name="test_1" class="form-control vTimeField" size="8" placeholder="Test" required id="id_test_1">'
            "</p>"
            "</div>"
        )
    ...
    def test_input_type_admin_split_date_time_horizontal(self):
        ...
        expected_html = (
            ...
            '<label class="col-md-3 col-form-label" for="id_test_0">Test</label>'
            '<div class="col-md-9">'
            '<p class="datetime">'
            "Date: "
            '<input type="text" name="test_0" class="form-control vDateField" size="10" placeholder="Test" required id="id_test_0">'
    ...
    # def test_input_type_admin_split_date_time_inline(self):
    ...
    #     )
    #     self.assertHTMLEqual(
    #         self.render('{% bootstrap_field form.test layout="inline" %}', context={"form": DateTimeTestForm()}),
    #         self.fix_django41(expected_html),
    #     )
