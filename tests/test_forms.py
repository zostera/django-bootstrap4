...
from .forms import ChoiceFieldTestForm, TestForm
    ...
    <div class="radio radio-success" id="id_category1">
        <div class="form-check form-check-inline">
            <label class="form-check-label" for="id_category1_0">
                <input class="form-check-input" id="id_category1_0"
                    name="category1" required="" title="" type="radio" value="1">
                Radio 1
            </label>
        </div>
        <div class="form-check form-check-inline">
            <label class="form-check-label" for="id_category1_1">
                <input class="form-check-input" id="id_category1_1"
                    name="category1" required="" title="" type="radio" value="2">
                Radio 2
            </label>
        </div>
    </div>
